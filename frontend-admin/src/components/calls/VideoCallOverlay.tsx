...
export default function VideoCallOverlay({
    ...
    if (isIncomingRinging) {
        return (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-gradient-to-br from-slate-900/95 via-gray-900/95 to-zinc-900/95 backdrop-blur-sm">
    ...
    if (isOutgoingRinging) {
        return (
            <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-gradient-to-br from-slate-900/95 via-gray-900/95 to-zinc-900/95 backdrop-blur-sm text-white">
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex flex-col bg-gray-900 overflow-hidden">
