										...
										return (
											...
											>
												{(() => {
													...
													return (
														<div
															className={`max-w-[82%] rounded-2xl px-3 py-2 shadow-sm ${isCallLog
																? isUser ? 'bg-blue-100 text-blue-900 border border-blue-200' : 'bg-gray-100 text-gray-900 border border-gray-200'
																: isUser
														...
														>
															...
															<div className={`mt-2 flex items-center gap-1 text-[10px] ${isCallLog ? (isUser ? 'text-blue-500' : 'text-gray-500') : (isUser || isAdmin ? 'text-white/80' : 'text-gray-500')}`}>
